...
import { convertNumberToHumanReadable, parseHumanReadableNumber, } from "../src/index";
...
test("test convertNumberToHumanReadable", () => {
    ...
    /* Test with options */
    expect(convertNumberToHumanReadable(1234, { useSuffix: false })).toBe("1234");
    expect(convertNumberToHumanReadable(1234, { useComma: true })).toBe("1.2K");
    expect(convertNumberToHumanReadable(1234567, { useComma: true })).toBe("1.2M");
    expect(convertNumberToHumanReadable(1234, { useSuffix: false, useComma: true })).toBe("1,234");
    /* Edge cases */
